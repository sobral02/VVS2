...
public class SaleRowDataGateway {
	...
	/**
	 * Sale's internal identification (unique, primary key, sequential) Generated by
	 * the database engine.
	 */
	private int id;
	...
	// public CustomerRowDataGateway(int id, int vat, String designation, int
	// phoneNumber) {
	// this.id = id;
	// this.vat = vat;
	...
	private static final String INSERT_SALE_SQL = "insert into sale (id, date, total, status, customer_vat) "
			+ "values (DEFAULT, ?, ?, ?, ?)";
	...
	private static final String GET_SALE_BY_CUSTOMERS_VAT_SQL = "select * from sale where customer_vat = ?";
	 ...
	 */
	private static final String UPDATE_STATUS_SQL = "update sale " + "set status = ? " + "where id = ?";
	 ...
	 * The update customerPhone SQL statement
	 */
	private static final String GET_SALE_BY_ID_SQL = "select * from sale " + "where id = ?";
	...
	private static final String DELETE_SALE_SQL = "delete from sale " + "where id = ?";
